...
.method public sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    .end local v18    # "part":Ljava/lang/String;
    :cond_0
    move-object/from16 v0, p0
    ...
    invoke-virtual {v1, v2, v3, v0}, Landroid/app/AppOpsManager;->hook_noteOp(IILjava/lang/String;)I
    ...
    .line 491
    .local v4, "singlePart":Ljava/lang/String;
    ...
    .line 498
    .local v5, "singleSentIntent":Landroid/app/PendingIntent;
    if-eqz p5, :cond_3
    ...
    .end local v5    # "singleSentIntent":Landroid/app/PendingIntent;
    check-cast v5, Landroid/app/PendingIntent;

    .line 502
    .restart local v5    # "singleSentIntent":Landroid/app/PendingIntent;
    :cond_3
    const/4 v6, 0x0
    ...
    .line 507
    .restart local v6    # "singleDeliveryIntent":Landroid/app/PendingIntent;
    :cond_4
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/internal/telephony/SMSDispatcher;->sendText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    .line 514
    .end local v4    # "singlePart":Ljava/lang/String;
    .end local v15    # "i":I
    :cond_6
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mDispatcher:Lcom/android/internal/telephony/SMSDispatcher;
    ...
    invoke-virtual/range {v7 .. v14}, Lcom/android/internal/telephony/SMSDispatcher;->sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Landroid/net/Uri;Ljava/lang/String;)V
