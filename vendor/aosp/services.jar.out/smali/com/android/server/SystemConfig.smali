...
.method private readPermissionsFromXml(Ljava/io/File;Z)V
    ...
    const-string/jumbo v28, "No start tag found"
    ...
    :try_start_2
    const-string/jumbo v27, "SystemConfig"

    const-string/jumbo v28, "Got exception parsing permissions."
    ...
    const-string/jumbo v29, "Removed unavailable feature "
    ...
    const-string/jumbo v29, "Couldn\'t find or open permissions file "
    ...
    const-string/jumbo v29, "Unexpected start tag in "
    ...
    .line 236
    const-string/jumbo v29, ", expected \'permissions\' or \'config\'"
    ...
    .line 269
    :cond_8
    const-string/jumbo v27, "assign-permission"
    ...
    .line 301
    :cond_9
    const-string/jumbo v27, "library"
    ...
    const-string/jumbo v29, "<feature> without name in "
    ...
    const-string/jumbo v29, "<group> without gid in "
    ...
    const-string/jumbo v29, "<permission> without name in "
    ...
    const-string/jumbo v29, "<assign-permission> without name in "
    ...
    const-string/jumbo v29, "<assign-permission> without uid in "
    ...
    const-string/jumbo v29, "<assign-permission> with unknown uid \""
    ...
    const-string/jumbo v29, "<library> without name in "
    ...
    const-string/jumbo v29, "<library> without file in "
    ...
    .restart local v9    # "fname":Ljava/lang/String;
    :cond_18
    const-string/jumbo v27, "notLowRam"
    ...
    .end local v9    # "fname":Ljava/lang/String;
    :cond_1b
    const-string/jumbo v27, "unavailable-feature"
    ...
    const-string/jumbo v29, "<unavailable-feature> without name in "
    ...
    .end local v9    # "fname":Ljava/lang/String;
    :cond_1d
    const-string/jumbo v27, "allow-in-power-save-except-idle"
    ...
    .line 360
    :cond_1e
    const-string/jumbo v27, "allow-in-power-save"
    ...
    .line 371
    :cond_1f
    const-string/jumbo v27, "fixed-ime-app"
    ...
    .line 382
    :cond_20
    const-string/jumbo v27, "app-link"
    ...
    const-string/jumbo v29, "<app-link> without package in "
    ...
    const-string/jumbo v29, "<allow-in-power-save-except-idle> without package in "
    ...
    const-string/jumbo v29, "<allow-in-power-save> without package in "
    ...
    const-string/jumbo v29, "<fixed-ime-app> without package in "
    ...
    .end local v22    # "pkgname":Ljava/lang/String;
    :cond_28
    const-string/jumbo v27, "backup-transport-whitelisted-service"
    ...
    const-string/jumbo v29, "<backup-transport-whitelisted-service> without service in "
    ...
    const-string/jumbo v29, "<backup-transport-whitelisted-service> with invalid service name "
