...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .prologue
    .line 1382
    iget-boolean v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mIsTheCurrentActivePhone:Z
    ...
    .line 1389
    :sswitch_1
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v12, 0x6

    invoke-virtual {p0, v12}, Lcom/android/internal/telephony/gsm/GSMPhone;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-direct {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->storeVoiceMailNumber(Ljava/lang/String;)V

    .line 1414
    const/4 v11, 0x0

    invoke-direct {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->setVmSimImsi(Ljava/lang/String;)V

    .line 1417
    :cond_2
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSimRecordsLoadedRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-virtual {p0, v12, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImei:Ljava/lang/String;
    ...
    iput-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImeiSv:Ljava/lang/String;
    ...
    .line 1456
    .local v10, "ussdResult":[Ljava/lang/String;
    ...
    invoke-direct {p0, v11, v12}, Lcom/android/internal/telephony/gsm/GSMPhone;->onIncomingUSSD(ILjava/lang/String;)V
    :try_end_0
    ...
    const-string v12, "error parsing USSD"
    ...
    .end local v10    # "ussdResult":[Ljava/lang/String;
    :sswitch_8
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPendingMMIs:Ljava/util/ArrayList;
    ...
    check-cast v11, Lcom/android/internal/telephony/gsm/GsmMmiCode;

    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isPendingUSSD()Z
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->onUssdFinishedError()V
    ...
    invoke-virtual {v11}, Landroid/telephony/ServiceState;->setStateOff()V

    goto/16 :goto_0

    .line 1484
    .end local v3    # "i":I
    .end local v4    # "imsPhone":Lcom/android/internal/telephony/imsphone/ImsPhone;
    :sswitch_9
    iget-object v0, p1, Landroid/os/Message;->obj:Ljava/lang/Object;
    ...
    check-cast v7, Lcom/android/internal/telephony/gsm/SuppServiceNotification;

    .line 1486
    .local v7, "not":Lcom/android/internal/telephony/gsm/SuppServiceNotification;
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSsnRegistrants:Landroid/os/RegistrantList;

    invoke-virtual {v11, v0}, Landroid/os/RegistrantList;->notifyRegistrants(Landroid/os/AsyncResult;)V

    goto/16 :goto_0

    .line 1490
    .end local v0    # "ar":Landroid/os/AsyncResult;
    .end local v7    # "not":Lcom/android/internal/telephony/gsm/SuppServiceNotification;
    :sswitch_a
    iget-object v0, p1, Landroid/os/Message;->obj:Ljava/lang/Object;
    ...
    :goto_2
    iget-object v13, v1, Lcom/android/internal/telephony/gsm/GSMPhone$Cfu;->mSetCfNumber:Ljava/lang/String;
    ...
    .line 1496
    :cond_5
    iget-object v11, v1, Lcom/android/internal/telephony/gsm/GSMPhone$Cfu;->mOnComplete:Landroid/os/Message;
    ...
    .line 1504
    .restart local v0    # "ar":Landroid/os/AsyncResult;
    const-class v11, Lcom/android/internal/telephony/uicc/IccVmNotSupportedException;
    ...
    .line 1505
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmNumber:Ljava/lang/String;
    ...
    invoke-direct {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;)V
    ...
    .line 1531
    .restart local v0    # "ar":Landroid/os/AsyncResult;
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSST:Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;
    ...
    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->setNetworkSelectionModeAutomatic(Landroid/os/Message;)V

    .line 1533
    const-string v11, "GSMPhone"

    const-string v12, "SET_NETWORK_SELECTION_AUTOMATIC: set to automatic"
    ...
    const-string v12, "SET_NETWORK_SELECTION_AUTOMATIC: already automatic, ignore"
    ...
    invoke-direct {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->processIccRecordEvents(I)V
    ...
    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->saveClirSetting(I)V
    ...
    .end local v8    # "onComplete":Landroid/os/Message;
    :sswitch_10
    const-string v11, "EVENT_SUBSCRIPTION_ACTIVATED"

    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->log(Ljava/lang/String;)V

    .line 1559
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->onSubscriptionActivated()V

    goto/16 :goto_0

    .line 1563
    :sswitch_11
    const-string v11, "EVENT_SUBSCRIPTION_DEACTIVATED"

    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->log(Ljava/lang/String;)V

    .line 1564
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->onSubscriptionDeactivated()V
