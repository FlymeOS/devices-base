...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/PhoneProxy$1;
    }
.end annotation
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->mContext:Landroid/content/Context;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v7, "Error! This handler was not registered for this message type. Message: "
    ...
    .line 135
    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/PhoneProxy;->obtainMessage(I)Landroid/os/Message;

    move-result-object v7

    .line 134
    invoke-interface {v6, v7}, Lcom/android/internal/telephony/CommandsInterface;->getVoiceRadioTechnology(Landroid/os/Message;)V
    ...
    iput v6, p0, Lcom/android/internal/telephony/PhoneProxy;->mRilVersion:I

    goto :goto_0

    .line 142
    :cond_0
    const-string/jumbo v6, "Unexpected exception on EVENT_RIL_CONNECTED"
    ...
    .line 150
    const-string/jumbo v5, "EVENT_VOICE_RADIO_TECH_CHANGED"
    ...
    const-string/jumbo v7, ": newVoiceTech="
    ...
    .line 150
    .end local v4    # "newVoiceTech":I
    .end local v5    # "what":Ljava/lang/String;
    :cond_1
    const-string/jumbo v5, "EVENT_REQUEST_VOICE_RADIO_TECH_DONE"

    .restart local v5    # "what":Ljava/lang/String;
    goto :goto_1
    ...
    const-string/jumbo v7, ": has no tech!"
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/PhoneProxy;->phoneObjectUpdater(I)V
    ...
    .line 182
    .local v3, "configMgr":Landroid/telephony/CarrierConfigManager;
    iget-object v6, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-virtual {v3, v6}, Landroid/telephony/CarrierConfigManager;->getConfigForSubId(I)Landroid/os/PersistableBundle;
    ...
    .line 185
    const-string/jumbo v6, "broadcast_emergency_call_state_changes_bool"
    ...
    .line 186
    .local v2, "broadcastEmergencyCallStateChanges":Z
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "broadcastEmergencyCallStateChanges ="
    ...
    invoke-interface {v6, v2}, Lcom/android/internal/telephony/Phone;->setBroadcastEmergencyCallStateChanges(Z)V

    goto/16 :goto_0

    .line 173
    .end local v1    # "b":Landroid/os/PersistableBundle;
    .end local v2    # "broadcastEmergencyCallStateChanges":Z
    .end local v3    # "configMgr":Landroid/telephony/CarrierConfigManager;
    :cond_5
    iget-object v6, p0, Lcom/android/internal/telephony/PhoneProxy;->mCommandsInterface:Lcom/android/internal/telephony/CommandsInterface;
    ...
    .restart local v3    # "configMgr":Landroid/telephony/CarrierConfigManager;
    :cond_6
    const-string/jumbo v6, "didn\'t get broadcastEmergencyCallStateChanges from carrier config"
...
.method public setBroadcastEmergencyCallStateChanges(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->setBroadcastEmergencyCallStateChanges(Z)V
