...
.method private persistVolume(Landroid/media/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {p1}, Landroid/media/AudioService$VolumeStreamState;->access$4800(Landroid/media/AudioService$VolumeStreamState;)I
...
.method private setDeviceVolume(Landroid/media/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v0, v9}, Landroid/media/AudioService;->access$4400(Landroid/media/AudioService;I)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Landroid/media/AudioService;->mSystemReady:Z
    invoke-static {v1}, Landroid/media/AudioService;->access$5200(Landroid/media/AudioService;)Z
    ...
    invoke-static {}, Landroid/media/AudioService;->access$5900()V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$7100(Landroid/media/AudioService;)Z
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$7200(Landroid/media/AudioService;)Landroid/hardware/hdmi/HdmiControlManager;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$7300(Landroid/media/AudioService;)Landroid/hardware/hdmi/HdmiTvClient;
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$7400(Landroid/media/AudioService;)Z
    ...
    invoke-static {v2, v3, v4, v1}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;IILjava/lang/String;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$7700(Landroid/media/AudioService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v2, v1, v3}, Landroid/media/AudioService;->access$7800(Landroid/media/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-static {v2, v1, v3}, Landroid/media/AudioService;->access$7900(Landroid/media/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8100(Landroid/media/AudioService;)V
    ...
    invoke-static {v2, v1}, Landroid/media/AudioService;->access$8200(Landroid/media/AudioService;Z)V
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8300(Landroid/media/AudioService;I)V
